...
<head>
<meta charset="utf-8">
<title>Job Portal Support</title>
...
<div class="navbar navbar-fixed-top" style="position: fixed;">
	<div class="navbar-inner owl-gradient">
		<div class="container"> 
		  <a class="brand"  href="index" onclick="owlphinhome()">
	    ...
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ol class="faq-list">
				<li>
				  <h4>What is Job Portal? How does the system work?</h4>
				  ...
				  <p>Job Portal is a job seacrh website that automates the screening and shortlisting processes of recruitment. 
				...
				<li>
				  <h4>Who is behind Job Portal?</h4>
				  <p> Job Portal is a privately held company with global ambitions and consists of a well seasoned
				  management team and advisors. Kwabena Aboagye Dougan founded this company.</p>	
				</li>
				<li>
				  <h4> Is Job Portal a recruitment firm?</h4>
				  <p> No. Job Portal is NOT a recruitment agency. We do not do candidate interviewing but automate short-listing. 
	  ...
	  <div class="row" style="margin-top:5px">
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ul>
				<li><h4><a href="index" onclick="owlphinhome()">Front page</a></h4></li>
