...
if(isset($_POST["e"])){	
	...
	if($email == ""){
		...
		$subject = 'jobportal Account Forgot Password';
		...
		$message .= '<div style="padding: 20px;background-color: rgb(217, 226, 245);"><a href="http://jobportal.com/reset&'.$eo_hash.'">Click here to reset password</a></div>';
		$message .= '<br /><br /><br /><span style="font-size:16px;"><b>Job Portal Security Team</b></span></body></html>';
		$headers = "From: jobportal-noreply@jobportal.com\r\n";
		$headers .= "Reply-To: jobportal-noreply@jobportal.com\r\n";
		$headers .= "Return-Path: jobportal-noreply@jobportal.com\r\n";
		$headers .= "CC: jobportal-noreply@jobportal.com\r\n";
		$headers .= "BCC: jobportal-noreply@jobportal.com\r\n";
