	...
	<div class="row">
	  ...
	  <div class="span3">
		<div class="contact-section-text">
		  ...
		  <p class="contact-info-text">Direct Dial: 234-54-911-2267</p>
		  <p class="contact-info-text">Toll-Free: 234-20-901-3836</p>
		  <p class="contact-info-text">Fax: 234-20-494-4216</p><br/>
		  <p class="contact-info-text"><a href="mailto:contact@jobportal.com">contact@jobportal.com</a></p>
		</div>
	  </div>
	  <div class="span3">
		<div class="contact-section-text">
		  <p class="contact-info-header-text">SWING BY</p>
		  <p class="contact-info-text">Job Portal</p>
		  <p class="contact-info-text">8, Mudashiru close, Ejigbo, Lagos</p>
		  <p class="contact-info-text">Lagos, Nigeria</p>
		</div>
	  </div>
	</div>
  </div>
